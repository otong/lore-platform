...
class OpenSearchEngine implements KnowledgeSearchInterface
{
    public function search(int $organizationId, array $criteria, int $perPage = 15): LengthAwarePaginator
    {
        throw new \BadMethodCallException('OpenSearch driver is not installed. Please set KNOWLEDGE_SEARCH_DRIVER=database.');
    }
