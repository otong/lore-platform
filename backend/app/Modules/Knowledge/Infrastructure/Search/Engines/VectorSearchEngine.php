...
class VectorSearchEngine implements KnowledgeSearchInterface
{
    public function search(int $organizationId, array $criteria, int $perPage = 15): LengthAwarePaginator
    {
        throw new \BadMethodCallException('Vector Search driver is not installed. Please set KNOWLEDGE_SEARCH_DRIVER=database.');
    }
